sap.ui.define([
	 ...
	 */
	const thisController = BaseController.extend("food-service.food-service.controller.Main",
		/** @lends zgagarin.zsupplyproc.controller.tabs.General.prototype */
		{
			...
			navToManagementCompany:function(oEvent){
				this.getRouter().navTo("management");
			},
		});
