sap.ui.define([
	 ...
	 */
	const thisController = BaseController.extend("food-service.food-service.controller.ManagementCompany",
		/** @lends zgagarin.zsupplyproc.controller.tabs.General.prototype */
		{
            ...
            navToManagentCurrentCompany:function(oEvent){
                this.getRouter().navTo("currentCompany");
            },
		});
