sap.ui.define([
	 ...
	 */
	const thisController = BaseController.extend("food-service.food-service.controller.CurrentCompany",
		/** @lends zgagarin.zsupplyproc.controller.tabs.General.prototype */
		{
            ...
            navToAddCompany:function(oEvent){
                this.getRouter().navTo("addCompany");
            },
            navToChartReport:function(oEvent){
                this.getRouter().navTo("chartReport");
			},
			navToCurrentMenu:function(oEvent){
				this.getRouter().navTo("currentMenu");
			},
			navToTableReport:function(oEvent){
				this.getRouter().navTo("tableReport");
			},
			navToRecomendation:function(oEvent){
				this.getRouter().navTo("recomendation");
			},
		});
